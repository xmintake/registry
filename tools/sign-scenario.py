#!/usr/bin/env python3
"""
Sign an XMRegistry .scenario.json file with Ed25519 (canonical JSON payload).

Usage:
  python3 tools/sign-scenario.py scenarios/xmintake/testing/pack-b-config.scenario.json \
    --private-key XMRegistry.private-key.pem

Signing covers the full JSON document except the top-level `signature` object.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Sign XMRegistry scenario JSON")
    ...
    document["signature"] = {"type": "ed25519", "value": signature}
